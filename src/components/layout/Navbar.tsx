...
import { Menu, X, Bell, MessageCircle, User, LogOut, Building2, CircleDollarSign, CreditCard, Calendar, Video } from 'lucide-react';
...
export const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    {
    icon: <CreditCard size={18} />,   // new Payment link
    text: "Payments",
    path: user ? "/payment" : "/login",
    },

    {
    icon: <Calendar size={18} />,   // new Calendar link
    text: "Calendar",
    path: user ? "/calendar" : "/login",
    },

    {
    icon: <Video size={18} />,   // new Video Call link
    text: "Video Call",
